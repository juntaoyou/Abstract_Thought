...
if __name__ == "__main__":
    ...
    with open(f"{neurons_path}/{model_name}_gsm_shared_neurons_{ratio}.json", "r") as f:
    ...
    save_neurons_to_json(random_neuron, f"./neuron_deactivation/{model_name}_gsm_random_neurons_{ratio}.json")
