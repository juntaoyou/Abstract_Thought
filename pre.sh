...
# CUDA_VISIBLE_DEVICES=7 python ./pre.py --eval 
CUDA_VISIBLE_DEVICES=2 python ./pre.py --eval  --add_principle --principle helpful
CUDA_VISIBLE_DEVICES=2 python ./pre.py --eval  --add_principle --principle correct
CUDA_VISIBLE_DEVICES=2 python ./pre.py --eval  --add_principle --principle coherent
